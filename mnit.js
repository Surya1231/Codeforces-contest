...
if (localStorage.second_year_cf_leaderboard) {
  try {
    second_year_cf_leaderboard = JSON.parse(
      localStorage.second_year_cf_leaderboard
    );
  } catch {
...
function render_alltime_leaderboard(json) {
  last_rendered = -1;
  var table =
    '<table class="table table-bordered table-striped"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">Name</th><th scope="col">Username</th><th scope="col"> Cur-Rating </th> <th scope="col">Max-Rating</th></tr></thead><tbody>';
  ...
  table += "</tbody></table>";
  var notf2 =
    "<h6> Codeforces leaderboard 2nd year MNIT(Jaipur) </h6><br/> <a href='https://mnit-portal.web.app/leaderboard'> Click to proceed to new Portal </a> ";
...
function render_contest_leaderboard(contest, json) {
  last_rendered = -1;
  var table =
    '<table class="table table-bordered table-striped"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">Username</th><th scope="col"> Score </th> <th scope="col"> Rank </th></tr></thead><tbody>';
  json.forEach((item, index) => {
    console.log(item);
    var rank = item.rank;
    ...
    var row_0 = '<th scope="row">' + (index + 1) + "</th>";
    var row_1 =
      '<td><a target="_blank" href="' + link + '">' + user_name + "</a></td>";
...
function all_time_leaderboard(element) {
  ...
  alert("This portal will soon migrated to  : https://mnit-portal.web.app/ ");
}
